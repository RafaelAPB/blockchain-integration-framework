...
data class TransferProposalReceiptMessage (
    ...
    val credentialProfile: TransferProposalReceiptMessage.CredentialProfile? = null,
    ...
    val clientIdentityPubkey: kotlin.String? = null,

    @Json(name = "serverIdentityPubkey")
    val serverIdentityPubkey: kotlin.String? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonInitMinusReceiptMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:init-receipt-msg") urnColonIetfColonSatpColonMsgtypeColonInitMinusReceiptMinusMsg("urn:ietf:satp:msgtype:init-receipt-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
