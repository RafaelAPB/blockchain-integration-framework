...
data class CommitFinalAssertionMessage (
    ...
    val credentialProfile: CommitFinalAssertionMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonCommitMinusFinalMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:commit-final-msg") urnColonIetfColonSatpColonMsgtypeColonCommitMinusFinalMinusMsg("urn:ietf:satp:msgtype:commit-final-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
