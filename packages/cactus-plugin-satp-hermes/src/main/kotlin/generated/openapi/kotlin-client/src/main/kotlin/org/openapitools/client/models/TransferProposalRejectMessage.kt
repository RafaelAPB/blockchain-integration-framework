...
data class TransferProposalRejectMessage (
    ...
    val credentialProfile: TransferProposalRejectMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonInitMinusRejectMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:init-reject-msg") urnColonIetfColonSatpColonMsgtypeColonInitMinusRejectMinusMsg("urn:ietf:satp:msgtype:init-reject-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
