...
data class CommitFinalAcknowledgementReceiptMessage (
    ...
    val credentialProfile: CommitFinalAcknowledgementReceiptMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonAckMinusCommitMinusFinalMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:ack-commit-final-msg") urnColonIetfColonSatpColonMsgtypeColonAckMinusCommitMinusFinalMinusMsg("urn:ietf:satp:msgtype:ack-commit-final-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
