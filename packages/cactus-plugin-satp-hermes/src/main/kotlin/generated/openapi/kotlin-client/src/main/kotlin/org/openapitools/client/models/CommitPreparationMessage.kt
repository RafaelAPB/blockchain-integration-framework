...
data class CommitPreparationMessage (
    ...
    val credentialProfile: CommitPreparationMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonCommitMinusPrepareMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:commit-prepare-msg") urnColonIetfColonSatpColonMsgtypeColonCommitMinusPrepareMinusMsg("urn:ietf:satp:msgtype:commit-prepare-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
