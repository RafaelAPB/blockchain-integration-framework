...
data class CommitReadyMessage (
    ...
    val credentialProfile: CommitReadyMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonCommitMinusReadyMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:commit-ready-msg") urnColonIetfColonSatpColonMsgtypeColonCommitMinusReadyMinusMsg("urn:ietf:satp:msgtype:commit-ready-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
