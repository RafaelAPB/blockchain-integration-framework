...
data class LockAssertionReceiptMessage (
    ...
    val credentialProfile: LockAssertionReceiptMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonAssertionMinusReceiptMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:assertion-receipt-msg") urnColonIetfColonSatpColonMsgtypeColonAssertionMinusReceiptMinusMsg("urn:ietf:satp:msgtype:assertion-receipt-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
