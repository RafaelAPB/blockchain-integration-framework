...
data class TransferCompleteMessage (
    ...
    val credentialProfile: TransferCompleteMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonCommitMinusTransferMinusCompleteMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:commit-transfer-complete-msg") urnColonIetfColonSatpColonMsgtypeColonCommitMinusTransferMinusCompleteMinusMsg("urn:ietf:satp:msgtype:commit-transfer-complete-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
