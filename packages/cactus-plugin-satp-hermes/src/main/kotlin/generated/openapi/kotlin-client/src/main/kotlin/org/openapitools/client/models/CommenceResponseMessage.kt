...
data class CommenceResponseMessage (
    ...
    val credentialProfile: CommenceResponseMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonAckMinusCommenceMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:ack-commence-msg") urnColonIetfColonSatpColonMsgtypeColonAckMinusCommenceMinusMsg("urn:ietf:satp:msgtype:ack-commence-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
