...
data class TransferCommenceMessage (
    ...
    val credentialProfile: TransferCommenceMessage.CredentialProfile? = null,
     ...
     * 
     *
     * Values: urnColonIetfColonSatpColonMsgtypeColonTransferMinusCommenceMinusMsg
     */
    @JsonClass(generateAdapter = false)
    enum class MessageType(val value: kotlin.String) {
        @Json(name = "urn:ietf:satp:msgtype:transfer-commence-msg") urnColonIetfColonSatpColonMsgtypeColonTransferMinusCommenceMinusMsg("urn:ietf:satp:msgtype:transfer-commence-msg");
    }
    /**
     * Specify type of auth (SAML, OAuth, X.509)
     *
