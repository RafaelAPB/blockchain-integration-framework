...
export enum MessageType {
  /**
   * @generated from enum value: MESSAGE_TYPE_INIT_PROPOSAL_MSG = 0;
   */
  INIT_PROPOSAL_MSG = 0,

  /**
   * @generated from enum value: MESSAGE_TYPE_INIT_RECEIPT_MSG = 1;
   */
  INIT_RECEIPT_MSG = 1,

  /**
   * @generated from enum value: MESSAGE_TYPE_INIT_REJECT_MSG = 2;
   */
  INIT_REJECT_MSG = 2,

  /**
   * @generated from enum value: MESSAGE_TYPE_TRANSFER_COMMENCE_MSG = 3;
   */
  TRANSFER_COMMENCE_MSG = 3,

  /**
   * @generated from enum value: MESSAGE_TYPE_LOCK_ASSERT_MSG = 4;
   */
  LOCK_ASSERT_MSG = 4,

  /**
   * @generated from enum value: MESSAGE_TYPE_ASSERTION_RECEIPT_MSG = 5;
   */
  ASSERTION_RECEIPT_MSG = 5,

  /**
   * @generated from enum value: MESSAGE_TYPE_COMMIT_PREPARE_MSG = 6;
   */
  COMMIT_PREPARE_MSG = 6,

  /**
   * @generated from enum value: MESSAGE_TYPE_COMMIT_READY_MSG = 7;
   */
  COMMIT_READY_MSG = 7,

  /**
   * @generated from enum value: MESSAGE_TYPE_COMMIT_FINAL_MSG = 8;
   */
  COMMIT_FINAL_MSG = 8,

  /**
   * @generated from enum value: MESSAGE_TYPE_ACK_COMMIT_FINAL_MSG = 9;
   */
  ACK_COMMIT_FINAL_MSG = 9,

  /**
   * @generated from enum value: MESSAGE_TYPE_COMMIT_TRANSFER_COMPLETE_MSG = 10;
   */
  COMMIT_TRANSFER_COMPLETE_MSG = 10,
}
...
proto3.util.setEnumType(MessageType, "cacti.satp.v02.common.MessageType", [
  { no: 0, name: "MESSAGE_TYPE_INIT_PROPOSAL_MSG" },
  { no: 1, name: "MESSAGE_TYPE_INIT_RECEIPT_MSG" },
  { no: 2, name: "MESSAGE_TYPE_INIT_REJECT_MSG" },
  { no: 3, name: "MESSAGE_TYPE_TRANSFER_COMMENCE_MSG" },
  { no: 4, name: "MESSAGE_TYPE_LOCK_ASSERT_MSG" },
  { no: 5, name: "MESSAGE_TYPE_ASSERTION_RECEIPT_MSG" },
  { no: 6, name: "MESSAGE_TYPE_COMMIT_PREPARE_MSG" },
  { no: 7, name: "MESSAGE_TYPE_COMMIT_READY_MSG" },
  { no: 8, name: "MESSAGE_TYPE_COMMIT_FINAL_MSG" },
  { no: 9, name: "MESSAGE_TYPE_ACK_COMMIT_FINAL_MSG" },
  { no: 10, name: "MESSAGE_TYPE_COMMIT_TRANSFER_COMPLETE_MSG" },
]);
...
export class SATPMessage extends Message<SATPMessage> {
   ...
   */
  messageType = MessageType.INIT_PROPOSAL_MSG;
