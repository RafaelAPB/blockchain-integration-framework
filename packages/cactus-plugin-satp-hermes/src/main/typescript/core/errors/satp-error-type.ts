 ...
 *
 * In v02 this was a protobuf enum (`Error` in common/message_pb).
 * v13 replaced the wire-level enum with string-based error codes
 * (Section 14), so we define the classification locally for the
 * internal error hierarchy.  The numeric values are kept identical
 * to the v02 protobuf values for backward compatibility with
