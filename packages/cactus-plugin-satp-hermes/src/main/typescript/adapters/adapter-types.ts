 ...
 *
 * **Context Propagation:**
 * The invocation context flows from BLODispatcher → AdapterHookService → Individual
 ...
 * them into a single {@link AdapterHookResult}. The BLO examines dispositions to
