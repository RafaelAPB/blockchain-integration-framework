/**
 * API1 Adapter Type Definitions - External integration contracts for SATP gateway webhooks
 *
 * @fileoverview
 * Comprehensive type system for the API1 adapter framework enabling external systems
 ...
 *
 * @description
 * The API1 adapter system allows external controllers, monitoring platforms, and
