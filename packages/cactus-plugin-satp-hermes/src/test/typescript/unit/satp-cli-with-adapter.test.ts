...
describe("SATP CLI Adapter Configuration - Unit Tests", () => {
	describe("validateAdapterConfig - valid configurations", () => {
				...
				adapters: [
					{
						...
						executionPoints: [
							...
							{
								name: "post-session notify",
								stage: 0,
								step: "newSessionResponse",
								point: "after",
							},
							{
								name: "pre-transfer check",
								stage: 0,
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "before hook", stage: 1, step: "checkTransferProposalRequestMessage", point: "before" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "during hook", stage: 1, step: "transferProposalRequest", point: "during" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "after hook", stage: 1, step: "transferProposalResponse", point: "after" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "rollback hook", stage: 2, step: "lockAssertionRequest", point: "rollback" },
						],
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "test", stage: 0, step: "checkNewSessionRequest", point: "before" },
						],
		...
		it("should validate configuration with both inbound and outbound webhooks", () => {
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "compliance check", stage: 1, step: "checkTransferProposalRequestMessage", point: "before" },
						],
						outboundWebhook: {
			...
			expect(result?.adapters[0].outboundWebhook?.url).toBe("https://compliance.example.com/check");
			expect(result?.adapters[0].inboundWebhook?.urlSuffix).toBe("/inbound/compliance-decision");
		});
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "stage 0", stage: 0, step: "checkNewSessionRequest", point: "before" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "stage 1", stage: 1, step: "checkTransferProposalRequestMessage", point: "before" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "stage 2", stage: 2, step: "checkLockAssertionRequest", point: "before" },
						],
					...
					},
					{
						...
						active: true,
						executionPoints: [
							{ name: "stage 3", stage: 3, step: "checkCommitPreparationRequest", point: "before" },
						],
	...
	describe("validateAdapterConfig - invalid configurations", () => {
		it("should throw when configuration is not an object", () => {
			expect(() => {
				validateAdapterConfig({ configValue: "invalid" as unknown as AdapterLayerConfiguration });
				...
				adapters: [
					{
						name: "No ID Adapter",
						active: true,
						executionPoints: [{ name: "test", stage: 0, step: "checkNewSessionRequest", point: "before" }],
					},
				],
				...
				adapters: [
					{
						...
						name: "First Adapter",
						active: true,
						executionPoints: [{ name: "test1", stage: 0, step: "checkNewSessionRequest", point: "before" }],
					...
					},
					{
						...
						name: "Second Adapter",
						active: true,
						executionPoints: [{ name: "test2", stage: 1, step: "checkTransferProposalRequestMessage", point: "before" }],
		...
		it("should throw when execution points array is empty", () => {
			...
			expect(() => {
				validateAdapterConfig({ configValue: config });
			}).toThrow('Adapter "empty-points-adapter" must have at least one execution point');
		});
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "test", stage: 5, step: "checkNewSessionRequest", point: "before" },
						],
						outboundWebhook: { url: "https://example.com/webhook" },
					},
				],
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "test", stage: 0, step: "lockAssertion", point: "before" }, // lockAssertion is stage 2
						],
						outboundWebhook: { url: "https://example.com/webhook" },
					},
				],
				...
				adapters: [
					{
						...
						active: true,
						executionPoints: [
							{ name: "test", stage: 0, step: "checkNewSessionRequest", point: "middle" as "before" },
						],
						outboundWebhook: { url: "https://example.com/webhook" },
					},
				],
