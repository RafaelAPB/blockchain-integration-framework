...
import { v4 as uuidV4 } from "uuid";
import { ISatpLocalLog, PluginSatpGateway } from "../../../../main/typescript/gateway/plugin-satp-gateway";
...
let satpLog: ISatpLocalLog;
let satpLog2: ISatpLocalLog;
let satpLog3: ISatpLocalLog;
let satpLog4: ISatpLocalLog;
...
test("successful logging of proof to ipfs and sqlite", async () => {
  ...
  const retrievedLogRemote = await pluginSourceGateway.getLogFromRemote(satpLogKey);
